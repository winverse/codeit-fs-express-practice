...
2. `cd src/practices/01-project-setup/workspace`에서 `npm install express`, `npm install -D eslint @eslint/js`, `npm install -D --save-exact prettier`를 차례로 실행해 package와 lockfile을 함께 갱신합니다.
